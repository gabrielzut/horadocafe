        ...
        <?php require "php/DAO/ProdutoDAO.php";
            ...
            if(isset($_GET['opcao'])){
                ...
                switch($opcao){
                    ...
                    case "salgados":{
                        $produtos = $produtoDAO->listarCategoria("salgados");
                        $nomeBusca = "Salgados";
                        break;
                    }
                    case "lanches":{
                        $produtos = $produtoDAO->listarCategoria("lanches");
                        $nomeBusca = "Lanches";
                        break;
                    }
                    case "pratos":{
                        $produtos = $produtoDAO->listarCategoria("pratos");
                        $nomeBusca = "Pratos";
                        break;
                    }
                    case "bebidas":{
                        $produtos = $produtoDAO->listarCategoria("bebidas");
                        $nomeBusca = "Bebidas";
                        break;
                    }
                    case "guloseimas":{
                        $produtos = $produtoDAO->listarCategoria("guloseimas");
                        $nomeBusca = "Guloseimas";
                        break;
                    }
                    default:{
